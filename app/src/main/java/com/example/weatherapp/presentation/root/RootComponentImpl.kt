...
class RootComponentImpl @AssistedInject constructor(
    ...
    private val favouriteComponentImpl: FavouriteComponentImpl.Factory,
    private val searchComponentImpl: SearchComponentImpl.Factory,
    ...
    private fun child(
        ...
        return when(config) {
            ...
            Config.Favourite -> {
                val component = favouriteComponentImpl.create(
                    onCityItemClicked = {
